...
import {
    actionChangeChildren,
    actionChangeCounterStates,
} from '../../../redux/searchBar/actions'
import {
    searchBarCounterPropertiesSelector,
    searchBarCounterStatesSelector,
} from '../../../redux/searchBar/selectors'
...
const SearchCounter = () => {
    ...
    const handleSelectChange = () => {
        ...
        dispatch(
            actionChangeChildren([...children, selectRef.current?.value ?? '0'])
        )
    }
