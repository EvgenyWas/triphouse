...
const DesktopDatepicker = ({
    ...
    const compareStartAndPrevent =
        startDate?.getMonth() === getPreviousMonth(presentDate).getMonth()
    ...
    return (
        <DatePicker
            renderCustomHeader={({
                ...
                <div>
                    {presentDate.getDay() === currentDate.getDay() ? (
                        ...
                        >
                            <NavigationIcon modifier="previous">
                                {'<'}
                            </NavigationIcon>
                        </button>
                    )}
            ...
            onCalendarOpen={handleCalendarOpen({
                borderStyle: css`
                    border: 3px solid
                        ${({ theme }: any) => theme.colors.acceptYellow};
                `,
                childWrapper: 0,
            })}
        />
