    ...
    switch (action.type) {
        ...
        case SearchBarTypesActions.DATE_FROM:
            return {
                ...
                dateRange: {
                    ...state.dateRange,
                    dateFrom: action.payload as Date | null,
                },
            }
        case SearchBarTypesActions.DATE_TO:
            return {
                ...
                dateRange: {
                    ...state.dateRange,
                    dateTo: action.payload as Date | null,
                },
            }
            ...
            return {
                ...
                counter: {
                    ...
                    properties: {
                        ...
                        adults: action.payload as number,
                    },
                },
            }
        case SearchBarTypesActions.CHILDREN:
            return {
                ...
                counter: {
                    ...
                    properties: {
                        ...state.counter.properties,
                        children: action.payload as string[],
                    },
                },
            }
        case SearchBarTypesActions.ROOMS:
            return {
                ...
                counter: {
                    ...
                    properties: {
                        ...state.counter.properties,
                        rooms: action.payload as number,
                    },
                },
            }
            ...
            return {
                ...
                counter: {
                    ...
                    states: {
                        ...
                        ...(action.payload as TCounterState),
                    },
                },
            }
        default:
