...
describe('SEARCH_BAR_REDUCER', () => {
    ...
    describe('when initial state', () => {
        it('then should return initial state', () => {
            expect(
                searchBarReducer(undefined, {} as TSearchBarActions)
            ).toEqual(initialSearchBarState)
        })
    })
    ...
    describe('when set search', () => {
        it('then sould return state with updated search', () => {
            ...
            expect(searchBarReducer(undefined, mockResultSearch)).toEqual(
                mockSearchBarState
            )
        })
    })
    ...
    describe('when set dates', () => {
        ...
        it('then sould return state with updated date from', () => {
            ...
            expect(searchBarReducer(undefined, mockResultDate)).toEqual(
                mockSearchBarState
            )
        })
    ...
    describe('when change properties', () => {
        it('then sould return state with updated adults', () => {
            ...
            expect(searchBarReducer(undefined, mockResultAdults)).toEqual(
                mockSearchBarState
            )
        })
        ...
        it('then sould return state with updated children', () => {
            ...
            expect(searchBarReducer(undefined, mockResultChildren)).toEqual(
                mockSearchBarState
            )
        })
        ...
        it('then sould return state with updated rooms', () => {
            ...
            expect(searchBarReducer(undefined, mockResultRooms)).toEqual(
                mockSearchBarState
            )
        })
    })
    ...
    describe('when change elems states', () => {
        it('then sould return state with updated elems states', () => {
            ...
            expect(searchBarReducer(undefined, mockResultStates)).toEqual(
                mockSearchBarState
            )
        })
    })
