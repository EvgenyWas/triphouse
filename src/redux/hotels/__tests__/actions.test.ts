...
describe('HOTELS_ACTIONS', () => {
    ...
    describe('hotels request', () => {
        it('should create action request', () => {
            ...
            expect(actionGetPopularHotelsRequested()).toEqual(
                mockResultPopularHotelsRequest
            )
        })
        ...
        it('should create action request', () => {
            ...
            expect(actionGetAvailableHotelsRequested()).toEqual(
                mockResultAvailableHotelsRequest
            )
        })
    })
    ...
    describe('hotels succeed', () => {
        it('should create action succeed', () => {
            ...
            expect(
                actionGetPopularHotelsSucceed(testPayloadHotelsSucceed)
            ).toEqual(mockResultPopularHotelsSucceed)
        })
        ...
        it('should create action succeed', () => {
            ...
            expect(
                actionGetAvailableHotelsSucceed(testPayloadHotelsSucceed)
            ).toEqual(mockResultAvailableHotelsSucceed)
        })
    })
    ...
    describe('hotels failed', () => {
        it('should create action failed', () => {
            ...
            expect(
                actionGetPopularHotelsFailed(testPayloadHotelsFailed)
            ).toEqual(mockResultPopularHotelsFailed)
        })
        ...
        it('should create action failed', () => {
            ...
            expect(
                actionGetAvailableHotelsFailed(testPayloadHotelsFailed)
            ).toEqual(mockResultAvailableHotelsFailed)
        })
    })
    ...
    describe('current hotel', () => {
        it('should create action current hotel', () => {
            ...
            expect(actionSetCurrentHotel(testPayloadCurrentHotel)).toEqual(
                mockResultCurrentHotel
            )
        })
    })
})
